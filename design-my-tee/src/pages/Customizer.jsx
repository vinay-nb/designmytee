        ...
        <>
          ...
          >
            <div className="flex items-center min-h-screen">
              <div className="w-16 border-[2px] rounded-lg flex flex-col justify-center items-center ml-1 py-4 gap-4 glassmorphism tabs">
                {EditorTabs?.map((tab) => (
                  <Tab
                    key={tab?.name}
                    tab={tab}
